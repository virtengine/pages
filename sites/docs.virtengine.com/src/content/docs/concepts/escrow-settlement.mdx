...
<EscrowSequence caption="The settlement sequence. Funds rest in escrow until usage is reported, the dispute window passes, and x/settlement authorizes transfer of the agreed amount with no marketplace commission." />
...
At payout, the proposed `x/take` settlement policy is **0% marketplace
...
[Settlement Policy & Issuance](/concepts/take-and-bme/).
